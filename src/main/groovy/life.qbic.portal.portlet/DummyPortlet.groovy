...
/**
 * Entry point for portlet qube_dummy_portlet. This class derives from {@link QBiCPortletUI}, which is found in the {@code portal-utils-lib} library.
 *
...
@Log4j2
@CompileStatic
class DummyPortlet extends QBiCPortletUI {
